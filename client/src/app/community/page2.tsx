...
export default function CommunityPage() {
  ...
  return (
    <div className="h-full w-full px-10 py-5 bg-zinc-900 rounded-lg flex flex-col">
      ...
      <div className="bg-zinc-900 text-white h-full w-full overflow-y-auto scrollbar-hide font-sans ">
        <div className="">
          {/* Header and Search */}
          <div className="mb-10">
