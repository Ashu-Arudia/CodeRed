...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      ...
      {/* Main Card */}
      <div className="card w-full max-w-md bg-white/80 backdrop-blur-lg shadow-2xl border border-white/20 relative z-10">
        <div className="card-body p-8">
          {/* Header */}
          <div className="text-center mb-8">
            <div className="avatar placeholder mb-4">
              <div className="bg-gradient-to-br from-purple-500 to-blue-600 text-white rounded-full w-16 h-16 flex items-center justify-center">
       ...
       12a3 3 0 11-6 0 3 3 0 016 0z"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="btn btn-primary w-full bg-gradient-to-r from-purple-600 to-blue-600 border-none hover:from-purple-700 hover:to-blue-700 text-white font-semibold py-3 shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200"
            >
              {isLoading ? (
                <>
      ...
      <div className="absolute bottom-32 right-32 w-3 h-3 bg-blue-400 rounded-full opacity-60 animate-bounce animation-delay-1000"></div>
      <div className="absolute top-1/3 right-20 w-2 h-2 bg-pink-400 rounded-full opacity-60 animate-bounce animation-delay-2000"></div>
    </div>
  );
}
